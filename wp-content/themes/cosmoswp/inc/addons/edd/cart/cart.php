    ...
    class CosmosWP_Edd_Cart_Header {
        ...
        public function add_defaults($default_options = array()) {
            $defaults = array(
                ...
                'cwp-edd-cart-icon-padding'          => json_encode(array(
                    'desktop' => array(
                        'top'         => '',
                        'right'       => '',
                        'bottom'      => '',
                ...
                'cwp-edd-cart-icon-margin'           => json_encode(array(
                    'desktop' => array(
                        'top'         => '',
                        'right'       => '',
                        'bottom'      => '',
                ...
                'cwp-edd-cart-icon-styling'      => json_encode(array(
        ...
        public function customize_register( $wp_customize ) {
            ...
            /*Enable Icon */
            $wp_customize->add_setting( 'cwp-enable-edd-cart', array(
                'default'			=> $header_defaults['cwp-enable-edd-cart'],
                'sanitize_callback' => 'cosmoswp_sanitize_checkbox',
                'transport'         => 'refresh'
            ) );

            $wp_customize->add_control( 'cwp-enable-edd-cart', array(
            ...
            $wp_customize->add_setting('cwp-edd-cart-icon', array(
            ...
            /*Icon align*/
            $wp_customize->add_setting('cwp-edd-cart-icon-align', array(
            ...
            /*Icon Size*/
            $wp_customize->add_setting('cwp-edd-cart-icon-size', array(
            ...
            /*Margin*/
            $wp_customize->add_setting('cwp-edd-cart-icon-margin', array(
                'sanitize_callback' => 'cosmoswp_sanitize_field_default_css_box',
            ...
            /*Padding*/
            $wp_customize->add_setting('cwp-edd-cart-icon-padding', array(
                'sanitize_callback' => 'cosmoswp_sanitize_field_default_css_box',
            ...
            /*Tabs*/
            $wp_customize->add_setting('cwp-edd-cart-icon-styling', array(
        ...
        public function dynamic_css( $dynamic_css ){
            ...
            $cwp_edd_icon_css = $cwp_edd_icon_hover_css = $cwp_edd_icon_tablet_css= $cwp_edd_icon_desktop_css= '';

            /* Added dynamic CSS */
            $size     = cosmoswp_get_theme_options('cwp-edd-cart-icon-size');
            $styling  = cosmoswp_get_theme_options('cwp-edd-cart-icon-styling');
            ...
            /* margin */
            $dss_margin = cosmoswp_get_theme_options('cwp-edd-cart-icon-margin');
...
// desktop margin 
            ...
            if (strpos($dss_margin_desktop, 'px') !== false){
                $cwp_edd_icon_desktop_css		.= 'margin:'.$dss_margin_desktop.';';
            }
// tablet marign 
            $dss_margin_tablet  = cosmoswp_cssbox_values_inline($dss_margin,'tablet');
            if (strpos($dss_margin_tablet, 'px') !== false){
                $cwp_edd_icon_tablet_css		.= 'margin:'.$dss_margin_tablet.';';
            }
// mobile margin 
            $dss_margin_mobile  = cosmoswp_cssbox_values_inline($dss_margin,'mobile');
            if (strpos($dss_margin_mobile, 'px') !== false){
                $cwp_edd_icon_css		.= 'margin:'.$dss_margin_mobile.';';
            }
            /* padding */
            $dds_padding = cosmoswp_get_theme_options('cwp-edd-cart-icon-padding');
...
//bx shadow
            ...
            if (strpos($dds_shadow_css, 'px') !== false) {
                ...
                $cwp_edd_icon_css .=	'-webkit-box-shadow:'.$dds_bx_shadow.';';
                $cwp_edd_icon_css .=	'-moz-box-shadow:'.$dds_bx_shadow.';';
                $cwp_edd_icon_css .=	'box-shadow:'.$dds_bx_shadow.';';
            }

            /* normal css */
            if ( !empty( $cwp_edd_icon_css )){
                $dds_search_dynamic_css = '.cwp-edd-icon{
		'.$cwp_edd_icon_css.'
	}';
...
//bx shadow
            ...
            if (strpos($dds_hover_shadow_css, 'px') !== false) {
                ...
                $cwp_edd_icon_hover_css .=	'-webkit-box-shadow:'.$dds_hover_bx_shadow.';';
                $cwp_edd_icon_hover_css .=	'-moz-box-shadow:'.$dds_hover_bx_shadow.';';
                $cwp_edd_icon_hover_css .=	'box-shadow:'.$dds_hover_bx_shadow.';';
            }
            if ( !empty( $cwp_edd_icon_hover_css )){
                $dds_search_hover_dynamic_css = '.cwp-edd-icon:hover{
		'.$cwp_edd_icon_hover_css.'
            ...
            if ( !empty( $cwp_edd_icon_tablet_css )){
                $dds_icon_tablet_dynamic_css = '.cwp-edd-icon{
		'.$cwp_edd_icon_tablet_css.'
            ...
            if ( !empty( $cwp_edd_icon_desktop_css )){
                $dds_icon_desktop_dynamic_css = '.cwp-edd-icon{
...
if (!function_exists('cosmoswp_edd_cart_header')) {
    ...
    function cosmoswp_edd_cart_header() {
