...
if (!empty($footer_sidebar2)) {
    ...
    $wp_customize->add_setting('footer-sidebar-2-widget-setting-msg', array(
    ...
    $wp_customize->add_setting('footer-sidebar-2-widget-setting-option', array(
        'default'           => $footer_defaults['footer-sidebar-2-widget-setting-option'],
        'sanitize_callback' => 'cosmoswp_sanitize_select',
        'transport'         => 'postMessage'
    ));
    $choices = cosmoswp_inherit_options();
    $wp_customize->add_control('footer-sidebar-2-widget-setting-option', array(
    ...
    /*Content align*/
    $wp_customize->add_setting('footer-sidebar-2-content-align', array(
    ...
    /*Footer margin*/
    $wp_customize->add_setting('footer-sidebar-2-margin', array(
    ...
    /*Footer padding*/
    $wp_customize->add_setting('footer-sidebar-2-padding', array(
        'sanitize_callback' => 'cosmoswp_sanitize_field_default_css_box',
