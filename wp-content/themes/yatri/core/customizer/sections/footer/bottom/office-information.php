...
$wp_customize->add_setting(
    'bottom_footer_office_info_heading',
    array(
        'default' => '',
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Heading(
        ...
        array(
            ...
            'priority' => 100,
            'active_callback' => 'yatri_is_bottom_footer_office_info_enabled'
...
$wp_customize->add_setting(yatri_get_customizer_id('bottom_footer_office_info'),
    array(
        'default' => $default['bottom_footer_office_info'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Repeater(
        $wp_customize,
        yatri_get_customizer_id('bottom_footer_office_info'),
        array(
...
$wp_customize->add_setting(yatri_get_customizer_id('bottom_footer_office_info_design'),
    array(
        'default' => $default['bottom_footer_office_info_design'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Modal(
        $wp_customize,
        yatri_get_customizer_id('bottom_footer_office_info_design'),
        array(
...
$wp_customize->add_setting(yatri_get_customizer_id('bottom_footer_office_information_visibility'),
    array(
        'default' => $default['bottom_footer_office_information_visibility'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Switch_Group(
        $wp_customize,
        yatri_get_customizer_id('bottom_footer_office_information_visibility'),
        array(
