...
$wp_customize->add_setting(
    'bottom_footer_main_menu_heading',
    array(
        'default' => '',
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Heading(
        ...
        array(
            ...
            'priority' => 400,
            'active_callback' => 'yatri_is_bottom_footer_navigation_menu_enabled'

        )
    )
);
// Bottom Header Navigation
$wp_customize->add_setting(yatri_get_customizer_id('bottom_footer_main_menu'),
    array(
        'default' => $default['bottom_footer_main_menu'],
        'sanitize_callback' => 'yatri_sanitize_select',
    )
);

$wp_customize->add_control(yatri_get_customizer_id('bottom_footer_main_menu'),
    array(
...
$wp_customize->add_setting(yatri_get_customizer_id('bottom_footer_navigation_menu_design'),
    array(
        'default' => $default['bottom_footer_navigation_menu_design'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Modal(
        $wp_customize,
        yatri_get_customizer_id('bottom_footer_navigation_menu_design'),
        array(
