...
$wp_customize->add_setting(
    'bottom_header_off_canvas_heading',
    array(
        'default' => '',
...
$wp_customize->add_setting(yatri_get_customizer_id('bottom_header_offcanvas_open_from'),
    array(
        'default' => $default['bottom_header_offcanvas_open_from'],
        'sanitize_callback' => 'yatri_sanitize_select',
    )
);

$wp_customize->add_control(yatri_get_customizer_id('bottom_header_offcanvas_open_from'),
    array(
...
// Offcanvas Menu Type
$wp_customize->add_setting(yatri_get_customizer_id('bottom_header_offcanvas_menu_type'),
    array(
        'default' => $default['bottom_header_offcanvas_menu_type'],
        'sanitize_callback' => 'yatri_sanitize_select',
    )
);

$wp_customize->add_control(yatri_get_customizer_id('bottom_header_offcanvas_menu_type'),
    array(
...
$wp_customize->add_setting(yatri_get_customizer_id('bottom_header_offcanvas_menu_sidebar'),
    array(
        'default' => $default['bottom_header_offcanvas_menu_sidebar'],
        'sanitize_callback' => 'yatri_sanitize_select',
    )
);

$wp_customize->add_control(yatri_get_customizer_id('bottom_header_offcanvas_menu_sidebar'),
    array(
        ...
        'active_callback' => 'yatri_is_bottom_header_is_offcanvas_type_sidebar'

    )
);

// Offcanvas Menu Navigation Menu List
$wp_customize->add_setting(yatri_get_customizer_id('bottom_header_offcanvas_menu_nav_menu'),
    array(
        'default' => $default['bottom_header_offcanvas_menu_nav_menu'],
        'sanitize_callback' => 'yatri_sanitize_select',
    )
);

$wp_customize->add_control(yatri_get_customizer_id('bottom_header_offcanvas_menu_nav_menu'),
    array(
        ...
        'active_callback' => 'yatri_is_bottom_header_is_offcanvas_type_nav'

    )
);

// Setting show_bottom_header.
$wp_customize->add_setting(yatri_get_customizer_id('bottom_header_offcanvas_menu_width'),
    array(
        'default' => $default['bottom_header_offcanvas_menu_width'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Slider(
        $wp_customize,
        yatri_get_customizer_id('bottom_header_offcanvas_menu_width'),
        array(
...
$wp_customize->add_setting(yatri_get_customizer_id('bottom_header_offcanvas_menu_design'),
    array(
        'default' => $default['bottom_header_offcanvas_menu_design'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Modal(
        $wp_customize,
        yatri_get_customizer_id('bottom_header_offcanvas_menu_design'),
        array(
