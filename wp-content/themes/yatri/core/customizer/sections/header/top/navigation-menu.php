...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Heading(
        ...
        array(
            ...
            'priority' => 400,
            'active_callback' => 'yatri_is_top_header_navigation_menu_enabled'

        )
    )
);
// Top Header Navigation
$wp_customize->add_setting(yatri_get_customizer_id('top_header_main_menu'),
    array(
        'default' => $default['top_header_main_menu'],
        'sanitize_callback' => 'yatri_sanitize_select',
    )
);

$wp_customize->add_control(yatri_get_customizer_id('top_header_main_menu'),
    array(
        'label' => esc_html__('Navigation menu for top header', 'yatri'),
        'section' => 'yatri_section_top_header_options',
        'type' => 'select',
        'priority' => 420,
...
// Top Header Navigation Design

$wp_customize->add_setting(yatri_get_customizer_id('top_header_navigation_menu_design'),
    array(
        'default' => $default['top_header_navigation_menu_design'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Modal(
        $wp_customize,
        yatri_get_customizer_id('top_header_navigation_menu_design'),
        array(
