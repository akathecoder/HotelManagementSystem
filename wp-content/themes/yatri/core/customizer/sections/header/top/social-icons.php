...
$wp_customize->add_setting(
    'top_header_social_icons_heading',
    array(
        'default' => '',
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Heading(
        ...
        array(
            ...
            'priority' => 600,
            'active_callback' => 'yatri_is_top_header_social_enabled'
...
$wp_customize->add_setting(yatri_get_customizer_id('top_header_social_icons'),
    array(
        'default' => $default['top_header_social_icons'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Repeater(
        $wp_customize,
        yatri_get_customizer_id('top_header_social_icons'),
        array(
            'label' => esc_html__('Social Icons', 'yatri'),
...
// Top Header Office Info Design

$wp_customize->add_setting(yatri_get_customizer_id('top_header_social_icons_design'),
    array(
        'default' => $default['top_header_social_icons_design'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Modal(
        $wp_customize,
        yatri_get_customizer_id('top_header_social_icons_design'),
        array(
            'label' => esc_html__('Design & Styling', 'yatri'),
            'section' => 'yatri_section_top_header_options',
            'priority' => 640,
            'active_callback' => 'yatri_is_top_header_social_icons_enabled',
            'type' => 'yatri-style',
...
$wp_customize->add_setting(yatri_get_customizer_id('top_header_social_icons_visibility'),
    array(
        'default' => $default['top_header_social_icons_visibility'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Switch_Group(
        $wp_customize,
        yatri_get_customizer_id('top_header_social_icons_visibility'),
        array(
