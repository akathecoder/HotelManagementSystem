    ...
    <div class="yatri--css-ruler yatri--field-inputs">
		<span>
					<input <?php echo($top_disabled); ?> type="number" data-field-key="top"
                                                         class="yatri-input-css yatri-change-by-js padding_top"
        ...
        <input <?php echo($right_disabled); ?> type="number" data-field-key="right"
                                               class="yatri-input-css yatri-change-by-js padding_right"
        ...
        <span>
					<input <?php echo($bottom_disabled); ?>
                            type="number" data-field-key="bottom"
                            class="yatri-input-css yatri-change-by-js padding_bottom"
        ...
        <span>
					<input <?php echo($left_disabled); ?>
                            type="number" data-field-key="left" class="yatri-input-css yatri-change-by-js padding_left"
