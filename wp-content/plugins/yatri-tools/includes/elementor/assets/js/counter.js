(function ($) {
    ...
    var WidgetCounterHandler = function ($scope, $) {
        ...
        $scope.find('.yatri-tools-elementor-counter .count').each(function () {
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/yte-counter.default', WidgetCounterHandler);
    });
})(jQuery);